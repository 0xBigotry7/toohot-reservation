...
export async function POST(request: NextRequest) {
  try {
    ...
    // Calculate total reserved seats for the specific time slot
    ...
    const failureReason = !isAvailable ? `Not enough seats available (${availableSeats} available, ${partySize} requested)` : '';
